...
#        rm $df.xat
        ...
        ~/pyrt/dophot3.py -av -i10 -U PR,PX,PY,P2R,P2Y,PXY,P2XY,PX2Y,P3X,P3Y -M sbt $df -l12 -L11
        ln -s $df.xat ${base}t.fits.xat
# sscat-noradec ${base}t.fits
        ~/pyrt/cat2det.py ${base}t.fits
        ~/pyrt/dophot3.py -sv -U PR,PX,PY,P2R,P2Y,PXY,P2XY,PX2Y,P3X,P3Y -M sbt ${base}t.fits -l12 -L11
